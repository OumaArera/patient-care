            ...
            {currentPatients.map(({ patient }) => (
              <div key={patient.patientId} className="bg-gray-800 p-4 rounded-lg shadow-lg text-center relative">
                ...
                {showNewCharts && charts.length > 0 && chartData.length > 0 && (
                  <div className="absolute top-10 left-1/2 transform -translate-x-1/2 bg-gray-900 p-4 rounded-lg shadow-lg w-96 max-h-96 overflow-y-auto z-50 border border-gray-700">
                    <button
