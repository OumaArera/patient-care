            ...
            {currentPatients.map(({ patient }) => (
              <div key={patient.patientId} className="bg-gray-800 p-4 rounded-lg shadow-lg text-left relative">
                ...
                {showNewCharts && selectedPatientId === patient.patientId && chartData.length > 0 && (
                  <div 
                    className="fixed inset-0 flex items-center w-[70vw] h-[80vh] justify-center bg-black bg-opacity-50 z-50"
                  >
                    <div className="bg-gray-900 p-6 rounded-lg shadow-lg  overflow-y-auto border border-gray-700 relative">
                      <button
