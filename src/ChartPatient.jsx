...
const ChartPatient = () => {
  ...
  const fetchAllChartsData = async (patientId) => {
  ...
  return (
    <div className="flex">
      ...
      <div className="w-64 bg-gray-900 p-6">
        <h2 className="text-2xl font-bold text-blue-400">Patient Managers</h2>
      </div>

      {/* Main Content Area */}
      <div className="flex-1 p-6 bg-gray-900 text-white min-h-screen relative">
        {loading ? (
        ...
        {/* Overlay for NewCharts (Only Show if Both Data Sets Are Available) */}
