            ...
            <div key={patient.patientId} className="bg-gray-800 p-4 rounded-lg shadow-lg text-left relative">
              ...
              <div className="flex justify-between mt-4">
                {loadingCharts && selectedPatientId === patient.patientId ? (
                  ...
                  <>
                    <button
                      className="px-4 py-2 border border-blue-500 text-blue-600 rounded-md hover:bg-blue-100 mr-2"
              ...
              {showCharts&& selectedPatient && selectedPatientId === patient.patientId && selectedPatientId &&(
                <div
                  className="fixed inset-0 bg-opacity-50 flex justify-center items-center z-50"
