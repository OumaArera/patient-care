...
const MedAdministration = () => {
    ...
    const groupedByDate = filteredMedications.reduce((acc, admin) => {
        ...
        acc[dateKey].push(administeredMoment.format("HH:mm"));
    ...
    const tileClassName = ({ date }) => {
        ...
        return groupedByDate[dateKey] ? "bg-green-500 text-white" : "bg-red-500 text-white";
    };
            ...
            <Calendar 
                onClickDay={(date) => {
                    ...
                    if (groupedByDate[dateKey]) {
                        alert(`Administered times: ${groupedByDate[dateKey].join(", ")}`);
                    } else {
                        setShowResubmit(true);
